      ...
      <div className="space-y-6">
        ...
        <div className="card bg-gradient-to-r from-red-500 to-red-600 text-white">
          ...
          <div className="mt-4 flex gap-3">
            ...
            <button className="btn bg-white/20 hover:bg-white/30 text-white border-0 backdrop-blur-md">
              <Mic className="w-4 h-4 mr-2" />
              Mute
            </button>
            <button className="btn bg-white hover:bg-gray-100 text-red-600 border-0 ml-auto">
